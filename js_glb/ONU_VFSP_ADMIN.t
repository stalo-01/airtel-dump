              ...
              {   name:"<%T('Status')%>", 
                   target:0,
                    nodes:[
                            ...
                            {
                                    name:"<%T('Call Log')%>",
                                    target:"call_history_statistics.cgi"
                            },
                            {
                                    name:"<%T('NAT Mapping Table')%>",
                                    target:"nat_mapping.cgi?natmap"
                            },
                          ]
              }, 
              {   name:"<%T('Network')%>", 
              ...
              {   name:"<%T('Application')%>", 
                   target:0,
                    nodes:[
                            ...
                            <% end %>
                            {
                                    name:"<%T('Ringing Schedule')%>",
                                    target:"RingingSchedule.cgi"
                            },
                          ]
              }, 
              {   name:"<%T('Maintenance')%>", 
                   target:0,
                    nodes:[
                            ...
                            {
                                    name:"<%T('Uplink Management')%>",
                                    target:"uplink_management.cgi"
                            },
                            <% if has_usb then %>
                            {
                                    name:"<%T('Dongle Management')%>",
                                    target:"dongle.cgi"
                            },
                            <% end %>
                            {
