              ...
              {   name:"<%T('Status')%>", 
                   target:0,
                    nodes:[
                            ...
                            <% if has_wifi_hw then %>
                            {
                                    name:"<%T('STA Information')%>",
                                    target:"sta_info.cgi"
                            },
                            <% end %>
                            <% if has_wifi_hw then %>
                            {
                                    name:"<%T('Neighboring AP')%>",
                                    target:"neighboring_AP.cgi"
                            },
                            <% end %>
                            {
              ...
              {   name:"<%T('Network')%>", 
                   target:0,
                    nodes:[
                            ...
                            <% if has_wifi_24G then %>
                            {
                                    name:"<%T('WIFI Coverage Management')%>",
                                    target:"wlan_config.cgi?v=coverage"
                            },
                            <% end %>
                            <% if has_wifi_24G then %>
                            {
                                    name:"<%T('WIFI Noise Floor')%>",
                                    target:"wlan_config.cgi?v=noise"
                            },
                            <% end %>
                            {
                                    name:"<%T('IP Routing')%>",
                            ...
                            {
                                    name:"<%T('GRE Tunnel')%>",
                                    target:"gre_tunnel.cgi"
                            },
                            <% end %>
                            <% if has_classifier then %>
                            {
                                    name:"<%T('US Classifier')%>",
                                    target:"us_classifier.cgi"
                            },
                            <% end %>
                            {
                                    name:"<%T('QoS Config')%>",
                            ...
                            {
                                    name:"<%T('Vlan Binding')%>",
                                    target:"wan_config_glb.cgi?vbinding"
                            },
                          ]
              }, 
              {   name:"<%T('Security')%>", 
